...
func (e *Engine) run(ctx context.Context) error {
	...
	e.mail = email.New(email.Config{
		...
		DefaultDomains:       cfg.EmailDefaultDomains,
		DuckMailBase:         cfg.DuckMailBase,
		DuckMailKey:          cfg.DuckMailKey,
		CloudflareBase:       cfg.CloudflareBase,
		CloudflareKey:        cfg.CloudflareKey,
		CloudflareAuthMode:   cfg.CloudflareAuthMode,
		CloudflareCustomAuth: cfg.CloudflareCustomAuth,
		CloudflareRandomize:  cfg.CloudflareRandomizeSubdomain,
		CloudMailURL:         cfg.CloudMailURL,
		CloudMailAdminEmail:  cfg.CloudMailAdminEmail,
		CloudMailPassword:    cfg.CloudMailPassword,
		MailNestKey:          cfg.MailNestKey,
		MailNestProjectCode:  cfg.MailNestProjectCode,
		MoeMailBase:          cfg.MoeMailBase,
		MoeMailKey:           cfg.MoeMailKey,
		MoeMailDomain:        cfg.MoeMailDomain,
		MoeMailExpiryMS:      cfg.MoeMailExpiryMS,
		YYDSKey:              cfg.YYDSKey,
		YYDSJWT:              cfg.YYDSJWT,
		YYDSDomain:           cfg.YYDSDomain,
	})
	e.turn = turnstile.New(turnstile.Options{
		...
		Clear:           e.cm,
		ChromePath:      cfg.TurnstileChromePath,
		Python:          cfg.TurnstilePython,
		ScriptPath:      cfg.TurnstileScript,
		InjectClearance: cfg.TurnstileInjectClearance,
	})
